...
<section class="mx-auto max-w-2xl px-4 py-16 text-center">
    <div class="reveal rounded-[2rem] bg-white p-10 ring-1 ring-[color:var(--blush)]">
        ...
        <h1 class="font-display text-3xl font-extrabold text-[color:var(--berry)]">{{ __('Reservation request submitted') }}</h1>
        ...
        <div class="mt-6 rounded-2xl bg-[color:var(--cream)] px-4 py-5">
            ...
            <p class="mt-1 font-display text-2xl font-extrabold tracking-wider text-[color:var(--rose)]" dir="ltr">{{ $reservation->reference }}</p>
