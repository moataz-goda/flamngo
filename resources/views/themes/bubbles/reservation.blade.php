...
<section class="mx-auto max-w-3xl px-4 py-12">
    ...
    <div class="reveal mb-6 rounded-[1.5rem] bg-white p-5 ring-1 ring-[color:var(--blush)]" id="order-summary" data-items-total="{{ $total }}" data-currency-symbol="{{ currency_symbol() }}">
        ...
        <div class="mt-2 flex items-center justify-between border-t border-[color:var(--blush)] pt-2 text-base font-bold text-[color:var(--rose)]">
            <span>{{ __('Total') }}</span>
    ...
    <form action="{{ route('reservation.store') }}" method="POST" class="reveal space-y-5 rounded-[2rem] bg-white p-6 ring-1 ring-[color:var(--blush)] md:p-8">
        ...
        <div>
            <label class="mb-2 block text-sm font-bold text-[color:var(--berry)]">{{ __('Governorate') }} <span class="text-rose-500">*</span></label>
        ...
        <div>
            <label class="mb-2 block text-sm font-bold text-[color:var(--berry)]">{{ __('Address') }} <span class="text-rose-500">*</span></label>
